package md5b645d531482c5501b52170017e16dbc4;


public class LocationManagerDroid
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TempAtlas.Droid.LocationManagerDroid, TempAtlas.Android", LocationManagerDroid.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LocationManagerDroid.class)
			mono.android.TypeManager.Activate ("TempAtlas.Droid.LocationManagerDroid, TempAtlas.Android", "", this, new java.lang.Object[] {  });
	}
